...
declare module "../sdk" {
  export interface OptableSDK {
    ...
    runAdAuction: (domID: string, options?: RunAdAuctionOptions) => Promise<unknown>;
 ...
 */
OptableSDK.prototype.runAdAuction = async function (domID: string, options?: RunAdAuctionOptions): Promise<void> {
