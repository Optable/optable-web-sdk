...
| Flag                        | Read by                                           | Effect                                                                                |
| --------------------------- | ------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `optableDebug`              | `debugLog`, RTD module                            | Verbose logging, and nothing else.                                                    |
| `optableDebugOverrides`     | `shouldSample`, `setupAB`, `SkipTargetingForBots` | Bypass analytics sampling, force the treatment variant, skip bot detection.           |
