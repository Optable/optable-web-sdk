...
describe("SkipTargetingForBots", () => {
  ...
  it("returns false for a bot when optableDebugOverrides is set", () => {
    jest.spyOn(navigator, "userAgent", "get").mockReturnValue("Googlebot/2.1");
  ...
  it("clears a key left by an earlier bot-detected load in the same session", () => {
  ...
  it("still skips a bot when optableDebugOverrides is explicitly '0'", () => {
    jest.spyOn(navigator, "userAgent", "get").mockReturnValue("Googlebot/2.1");
  ...
  it("still skips a bot when only optableDebug is set, which controls logging", () => {
    jest.spyOn(navigator, "userAgent", "get").mockReturnValue("Googlebot/2.1");
